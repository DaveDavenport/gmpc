...
static GmpcWidgetSimilarArtist* gmpc_widget_similar_artist_construct (GType object_type, GmpcMetadataBrowser* more, MpdObj* server, const mpd_Song* song);
static GmpcWidgetSimilarArtist* gmpc_widget_similar_artist_new (GmpcMetadataBrowser* more, MpdObj* server, const mpd_Song* song);
		...
		if (result == META_DATA_FETCHING) {
					...
					artist = g_regex_escape_string (iter->tag, -1);
					{
						...
						do {
							...
							if (g_regex_match (reg, (const char*) liter->data, 0, NULL)) {
								in_db_list = g_list_prepend (in_db_list, gmpc_widget_similar_artist_new_artist_button (self, (const char*) liter->data, TRUE));
			...
			}
			{
				...
				for (artist_it = artist_collection; artist_it != NULL; artist_it = artist_it->next) {
					...
					char* artist;
					_tmp6 = NULL;
					artist = (_tmp6 = (const char*) artist_it->data, (_tmp6 == NULL) ? NULL : g_strdup (_tmp6));
					{
			...
			i = 0;
			{
				...
				for (item_it = item_collection; item_it != NULL; item_it = item_it->next) {
					...
					GtkWidget* item;
					_tmp8 = NULL;
					item = (_tmp8 = (GtkWidget*) item_it->data, (_tmp8 == NULL) ? NULL : g_object_ref (_tmp8));
					{
						if (i < 50) {
							...
							GObject* _tmp7;
							_tmp7 = NULL;
							_tmp7 = g_object_ref_sink ((GObject*) item);
...
static GmpcWidgetSimilarArtist* gmpc_widget_similar_artist_construct (GType object_type, GmpcMetadataBrowser* more, MpdObj* server, const mpd_Song* song) {
	...
	g_return_val_if_fail (more != NULL, NULL);
	...
	_tmp1 = NULL;
	_tmp0 = NULL;
	self->priv->more = (_tmp1 = (_tmp0 = more, (_tmp0 == NULL) ? NULL : g_object_ref (_tmp0)), (self->priv->more == NULL) ? NULL : (self->priv->more = (g_object_unref (self->priv->more), NULL)), _tmp1);
	_tmp3 = NULL;
	_tmp2 = NULL;
...
static GmpcWidgetSimilarArtist* gmpc_widget_similar_artist_new (GmpcMetadataBrowser* more, MpdObj* server, const mpd_Song* song) {
	return gmpc_widget_similar_artist_construct (GMPC_WIDGET_TYPE_SIMILAR_ARTIST, more, server, song);
}
...
static void gmpc_widget_similar_artist_finalize (GObject* obj) {
	...
	(self->priv->more == NULL) ? NULL : (self->priv->more = (g_object_unref (self->priv->more), NULL));
...
static void gmpc_metadata_browser_metadata_box_show_song (GmpcMetadataBrowser* self, const mpd_Song* song) {
	...
	if (mpd_sticker_supported (connection)) {
		...
		gtk_misc_set_alignment ((GtkMisc*) label, 0.0f, 0.5f);
		_tmp31 = NULL;
		gtk_label_set_markup (label, _tmp31 = g_markup_printf_escaped ("<b>%s:</b>", _ ("Rating")));
		_tmp31 = (g_free (_tmp31), NULL);
		gtk_table_attach (info_box, (GtkWidget*) label, (guint) 0, (guint) 1, (guint) i, (guint) (i + 1), GTK_SHRINK | GTK_FILL, GTK_SHRINK | GTK_FILL, (guint) 0, (guint) 0);
		_tmp32 = NULL;
		ali = (_tmp32 = g_object_ref_sink ((GtkAlignment*) gtk_alignment_new (0.0f, 0.5f, 0.f, 0.f)), (ali == NULL) ? NULL : (ali = (g_object_unref (ali), NULL)), _tmp32);
	...
	if (song->comment != NULL) {
		...
		char* _tmp35;
		_tmp33 = NULL;
		pt_label = (_tmp33 = g_object_ref_sink ((GtkLabel*) gtk_label_new (song->comment)), (pt_label == NULL) ? NULL : (pt_label = (g_object_unref (pt_label), NULL)), _tmp33);
		_tmp34 = NULL;
		label = (_tmp34 = g_object_ref_sink ((GtkLabel*) gtk_label_new ("")), (label == NULL) ? NULL : (label = (g_object_unref (label), NULL)), _tmp34);
		gtk_misc_set_alignment ((GtkMisc*) label, 0.0f, 0.0f);
		_tmp35 = NULL;
		gtk_label_set_markup (label, _tmp35 = g_markup_printf_escaped ("<b>%s:</b>", _ ("Comment")));
	...
	_tmp36 = NULL;
	hbox = (_tmp36 = g_object_ref_sink ((GtkHBox*) gtk_hbox_new (FALSE, 6)), (hbox == NULL) ? NULL : (hbox = (g_object_unref (hbox), NULL)), _tmp36);
	gtk_box_pack_start ((GtkBox*) hbox, (GtkWidget*) button, FALSE, FALSE, (guint) 0);
	_tmp37 = NULL;
	button = (_tmp37 = g_object_ref_sink ((GtkButton*) gtk_button_new_from_stock ("gtk-add")), (button == NULL) ? NULL : (button = (g_object_unref (button), NULL)), _tmp37);
	gtk_button_set_relief (button, GTK_RELIEF_NONE);
	g_signal_connect_object (button, "clicked", (GCallback) _gmpc_metadata_browser_add_selected_song_gtk_button_clicked, self, 0);
	gtk_box_pack_start ((GtkBox*) hbox, (GtkWidget*) button, FALSE, FALSE, (guint) 0);
	_tmp38 = NULL;
	button = (_tmp38 = g_object_ref_sink ((GtkButton*) gtk_button_new_with_mnemonic ("_Replace")), (button == NULL) ? NULL : (button = (g_object_unref (button), NULL)), _tmp38);
	_tmp39 = NULL;
	gtk_button_set_image (button, (GtkWidget*) (_tmp39 = g_object_ref_sink ((GtkImage*) gtk_image_new_from_stock ("gtk-redo", GTK_ICON_SIZE_BUTTON))));
...
static void gmpc_metadata_browser_metadata_box_show_artist (GmpcMetadataBrowser* self, const char* artist) {
	...
	gtk_box_pack_start ((GtkBox*) vbox, (GtkWidget*) frame, FALSE, FALSE, (guint) 0);
	_tmp19 = NULL;
	label = (_tmp19 = g_object_ref_sink ((GtkLabel*) gtk_label_new (_ ("Similar artist"))), (label == NULL) ? NULL : (label = (g_object_unref (label), NULL)), _tmp19);
	_tmp20 = NULL;
	gtk_label_set_markup (label, _tmp20 = g_strdup_printf ("<span weight='bold'>%s</span>", _ ("Similar artist")));
	_tmp20 = (g_free (_tmp20), NULL);
	gtk_misc_set_alignment ((GtkMisc*) label, 0.0f, 0.0f);
	gtk_box_pack_start ((GtkBox*) vbox, (GtkWidget*) label, FALSE, FALSE, (guint) 0);
