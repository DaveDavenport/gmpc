...
GmpcRating* gmpc_rating_new (void) {
	return gmpc_rating_construct (GMPC_TYPE_RATING);
}
...
static GObject * gmpc_rating_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	self = GMPC_RATING (obj);
	{
		...
		_tmp3 = NULL;
		self->priv->rat[0] = (_tmp3 = g_object_ref_sink ((GtkImage*) gtk_image_new_from_stock (GTK_STOCK_ABOUT, GTK_ICON_SIZE_MENU)), (self->priv->rat[0] == NULL) ? NULL : (self->priv->rat[0] = (g_object_unref (self->priv->rat[0]), NULL)), _tmp3);
		gtk_box_pack_start ((GtkBox*) self->priv->box, (GtkWidget*) self->priv->rat[0], FALSE, FALSE, (guint) 0);
		_tmp4 = NULL;
		self->priv->rat[1] = (_tmp4 = g_object_ref_sink ((GtkImage*) gtk_image_new_from_stock (GTK_STOCK_ABOUT, GTK_ICON_SIZE_MENU)), (self->priv->rat[1] == NULL) ? NULL : (self->priv->rat[1] = (g_object_unref (self->priv->rat[1]), NULL)), _tmp4);
		gtk_box_pack_start ((GtkBox*) self->priv->box, (GtkWidget*) self->priv->rat[1], FALSE, FALSE, (guint) 0);
		_tmp5 = NULL;
		self->priv->rat[2] = (_tmp5 = g_object_ref_sink ((GtkImage*) gtk_image_new_from_stock (GTK_STOCK_ABOUT, GTK_ICON_SIZE_MENU)), (self->priv->rat[2] == NULL) ? NULL : (self->priv->rat[2] = (g_object_unref (self->priv->rat[2]), NULL)), _tmp5);
		gtk_box_pack_start ((GtkBox*) self->priv->box, (GtkWidget*) self->priv->rat[2], FALSE, FALSE, (guint) 0);
		_tmp6 = NULL;
		self->priv->rat[3] = (_tmp6 = g_object_ref_sink ((GtkImage*) gtk_image_new_from_stock (GTK_STOCK_ABOUT, GTK_ICON_SIZE_MENU)), (self->priv->rat[3] == NULL) ? NULL : (self->priv->rat[3] = (g_object_unref (self->priv->rat[3]), NULL)), _tmp6);
		gtk_box_pack_start ((GtkBox*) self->priv->box, (GtkWidget*) self->priv->rat[3], FALSE, FALSE, (guint) 0);
		_tmp7 = NULL;
		self->priv->rat[4] = (_tmp7 = g_object_ref_sink ((GtkImage*) gtk_image_new_from_stock (GTK_STOCK_ABOUT, GTK_ICON_SIZE_MENU)), (self->priv->rat[4] == NULL) ? NULL : (self->priv->rat[4] = (g_object_unref (self->priv->rat[4]), NULL)), _tmp7);
