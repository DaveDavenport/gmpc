...
static void __async_handler_function(GSimpleAsyncResult *simple,
                                         GObject *object,
                                         GCancellable *cancel)
{
...
void mpd_async_request(MpdAsyncCallback *callback, gpointer callback_data, MpdAsyncFunction *function, gpointer function_data)
{
	 ...
	 * Timeout
	 */
	mpd_set_connection_timeout(data->mi, cfg_get_single_value_as_float_with_default(config,"connection","timeout",DEFAULT_TIMEOUT));
